/*
**      $Id: xy05c.c,v 1.1 1995-02-06 18:07:08 haley Exp $
*/
/************************************************************************
*                                                                       *
*                Copyright (C)  1995                                    *
...
**                  multiple lines in the plot.  Some of the XY marker resource
**                  are tweaked in the resource file to show how to change the
**                  appearance of these multiple lines.  This example also
**                  shows you how to use the xyYIrregularPoints resource to
**                  define your own Y axis values.
**
