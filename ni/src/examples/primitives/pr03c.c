/*
 *      $Id: pr03c.c,v 1.2 1996-05-13 19:58:56 haley Exp $
 */
/***********************************************************************
*                                                                      *
*                Copyright (C)  1996                                   *
 ...
 */
    ...
    NhlDraw(canvas);
/*
 * The polyline call uses the default GraphicStyle; Polygon and Polymarker
 * use the explicitly created GraphicStyle.
 */
