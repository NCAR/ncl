C
C      $Id: pr04f.f,v 1.3 2003-03-03 16:15:33 grubin Exp $
C
C***********************************************************************
C                                                                      *
C                Copyright (C)  1996                                   *
...
C   
      call NhlFRLClear(rlist)
      call NhlFRLSetString(rlist,'wkPDFFileName','./pr04.pdf',ierr)
      call NhlFCreate(wid,'pr04Work',NhFlpdfWorkstationClass,
     1    appid,rlist,ierr)
