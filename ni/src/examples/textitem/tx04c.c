/*
**      $Id: tx04c.c,v 1.3 1995-02-03 15:57:41 haley Exp $
*/
/************************************************************************
*                                                                       *
*                Copyright (C)  1995                                    *
...
*/
	...
	NhlRLSetFloat(rlist,	NhlNtxPosXF,.5);
	NhlRLSetFloat(rlist,	NhlNtxPosYF,.95 - (i++) * .027);
	NhlRLSetString(rlist,	NhlNtxString,"complex greek: $F21$NhlNtxFont = 8");
	NhlSetValues(text_item_id,rlist);
	...
	NhlRLSetFloat(rlist,NhlNtxPosXF,.5);
	NhlRLSetFloat(rlist,NhlNtxPosYF,.95 - (i++) * .027);
	NhlRLSetString(rlist,NhlNtxString,"helvetica: $F21$NhlNtxFont = 21");
	NhlSetValues(text_item_id,rlist);
