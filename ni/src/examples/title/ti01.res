...
! *ti01Work.Titles.tiDeltaF             : 1.5
!
!       When true, the X and Y titles inherit the resources set
!       for the main title.
! *ti01Work.Titles.tiUseMainAttributes  : False
!
!  ==============================================================
...
!  the title String.
! *ti01Work.Titles.tiMainOn             : False
! *ti01Work.Titles.tiXAxisOn            : False
! *ti01Work.Titles.tiYAxisOn            : False
!
...
! *ti01Work.Titles.tiMainSide           : TOP
! *ti01Work.Titles.tiXAxisSide          : BOTTOM
! *ti01Work.Titles.tiYAxisSide          : LEFT
!
...
! *ti01Work.Titles.tiMainPosition       : CENTER
! *ti01Work.Titles.tiXAxisPosition      : CENTER
! *ti01Work.Titles.tiYAxisPosition      : CENTER
!
...
! *ti01Work.Titles.tiMainOffsetXF       : 0.0
! *ti01Work.Titles.tiXAxisOffsetXF      : 0.0
! *ti01Work.Titles.tiYAxisOffsetXF      : 0.0
!
!       Sets an offset in NDC coordinates by which a title
!  will be displaced in a a direction parallel to the Y-Axis from
!  its base location. This offset goes beyond any offset due to
!  tiDeltaF. It does not scale in response to a changing viewport.
! *ti01Work.Titles.tiMainOffsetYF       : 0.0
! *ti01Work.Titles.tiXAxisOffsetYF      : 0.0
! *ti01Work.Titles.tiYAxisOffsetYF      : 0.0
!
...
!       BOTTOMRIGHT
!
! *ti01Work.Titles.tiMainJust           : CENTERCENTER
! *ti01Work.Titles.tiXAxisJust          : CENTERCENTER
! *ti01Work.Titles.tiYAxisJust          : CENTERCENTER
!
!       Angle of counter-clockwise rotation of a title.
! *ti01Work.Titles.tiMainAngleF         : 0.0
! *ti01Work.Titles.tiXAxisAngleF        : 0.0
! *ti01Work.Titles.tiYAxisAngleF        : 90.0
!
!       Direction in which text is to be drawn   (UP, DOWN, ACROSS)
! *ti01Work.Titles.tiMainDirection      : ACROSS
! *ti01Work.Titles.tiXAxisDirection     : ACROSS
! *ti01Work.Titles.tiYAxisDirection     : ACROSS
!
!
!  =============================================================
...
!
! *ti01Work.Titles.tiMainFont             : 0
! *ti01Work.Titles.tiXAxisFont            : 0
! *ti01Work.Titles.tiYAxisFont            : 0
!
...
!   106-114   blacks
!
! *ti01Work.Titles.tiMainFontColor        : 1
! *ti01Work.Titles.tiXAxisFontColor       : 1
! *ti01Work.Titles.tiYAxisFontColor       : 1
!
!       The character height in NDCs of the text to be written
! *ti01Work.Titles.tiMainFontHeightF      : .025
! *ti01Work.Titles.tiXAxisFontHeightF     : .025
! *ti01Work.Titles.tiYAxisFontHeightF     : .025
!
!       The height/width aspect ratio of the text to be written
! *ti01Work.Titles.tiMainFontAspectF      : 1.3125
! *ti01Work.Titles.tiXAxisFontAspectF     : 1.3125
! *ti01Work.Titles.tiYAxisFontAspectF     : 1.3125
!
!       The width of the lines that form the text outline
! *ti01Work.Titles.tiMainFontThicknessF       : 1.0
! *ti01Work.Titles.tiXAxisFontThicknessF      : 1.0
! *ti01Work.Titles.tiYAxisFontThicknessF      : 1.0
!
!       The degree of quality of the text to be written (LOW,MEDIUM,HIGH)
! *ti01Work.Titles.tiMainFontQuality      : HIGH
! *ti01Work.Titles.tiXAxisFontQuality     : HIGH
! *ti01Work.Titles.tiYAxisFontQuality     : HIGH
!
!       The spacing between characters of the text to be written
! *ti01Work.Titles.tiMainConstantSpacingF : 0.0
! *ti01Work.Titles.tiXAxisConstantSpacingF: 0.0
! *ti01Work.Titles.tiYAxisConstantSpacingF: 0.0
!
!       A process for accessing the many characters of the default
!       pwritx font.
! *ti01Work.Titles.tiMainFuncCode         : :
! *ti01Work.Titles.tiXAxisFuncCode        : :
! *ti01Work.Titles.tiYAxisFuncCode        : :
!
