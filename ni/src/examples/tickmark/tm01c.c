 ...
 */
        ...
        NhlCreate(&wid,"tm01Work",NhlcairoWindowWorkstationClass,
                  NhlDEFAULT_APP,rlist);
    }
 ...
 */
        NhlRLClear(rlist);
        NhlRLSetString(rlist,NhlNwkPDFFileName,"./tm01c.pdf");
        NhlCreate(&wid,"tm01Work",NhlpdfWorkstationClass,
                  NhlDEFAULT_APP,rlist);
    }
 ...
 */
        NhlRLClear(rlist);
        NhlRLSetString(rlist,NhlNwkFileName,"./tm01c");
        NhlRLSetString(rlist,NhlNwkFormat,(char*)wks_type);
        NhlCreate(&wid,"tm01Work",NhlcairoDocumentWorkstationClass,
                  NhlDEFAULT_APP,rlist);
    }
 ...
 */
        ...
        NhlRLSetString(rlist,NhlNwkFileName,"./tm01c");
        NhlRLSetString(rlist,NhlNwkFormat,(char*)wks_type);
        NhlCreate(&wid,"tm01Work",NhlcairoImageWorkstationClass,
                  NhlDEFAULT_APP,rlist);
    }
/*
