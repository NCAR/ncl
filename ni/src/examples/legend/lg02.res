...
! lg02.lg02Work.Legend.lgLegend              : True
!
!       Is title and label sizing to be done automatically
! lg02.lg02Work.Legend.lgAutoManage          : True
!
!       Should the legend be HORIZONTAL or VERTICAL
! lg02.lg02Work.Legend.lgOrientation         : VERTICAL
!
...
!       CENTERRIGHT
!       BOTTOMRIGHT
! lg02.lg02Work.Legend.lgJustification       : BOTTOMLEFT
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! lg02.lg02Work.Legend.lgLeftMarginF         : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! lg02.lg02Work.Legend.lgRightMarginF        : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! lg02.lg02Work.Legend.lgBottomMarginF       : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! lg02.lg02Work.Legend.lgTopMarginF          : .05
!
! ------------------
! THE LEGEND TITLE
! ------------------
...
! lg02.lg02Work.Legend.lgDrawTitle           : 1
!
...
! lg02.lg02Work.Legend.lgTitleDirection       : ACROSS
!
...
!       CENTERRIGHT
!       BOTTOMRIGHT
! lg02.lg02Work.Legend.lgTitleJust           : CENTERCENTER
!
...
!
lg02.lg02Work.Legend.lgTitleFont            : 25
!
...
! lg02.lg02Work.Legend.lgDrawPerim           : 1
!
!       Color of the legend perim
! lg02.lg02Work.Legend.lgPerimColor          : FOREGROUND
!
!       Fill sytle of the legend perim
! lg02.lg02Work.Legend.lgPerimFill           : FOREGROUND
!
!       Fill color of the legend perim
! lg02.lg02Work.Legend.lgPerimFillColor      : FOREGROUND
!
!       Width of the legend perim
! lg02.lg02Work.Legend.lgPerimThicknessF     : 1.0
!
!       Dash pattern of the legend perim
! lg02.lg02Work.Legend.lgPerimDashPattern    : 0
!
!       Length of dash segments of the legend perim
! lg02.lg02Work.Legend.lgPerimDashSegLenF    : 0.15
!
! ------------------------
...
! lg02.lg02Work.Legend.lgBoxBackground       : TRANSPARENT
!
!       A relative box width.  0. = no width, 1. = touching boxes
! lg02.lg02Work.Legend.lgBoxMajorExtentF     : 1.0
!
!       A relative box length in a box + label pair.
!       If set to 1.0 it crowds out the label.
! lg02.lg02Work.Legend.lgBoxMinorExtentF     : 0.33
!
!       Draw the box perimeters  (0 is off, 1 is on)
! lg02.lg02Work.Legend.lgDrawBoxLines        : 0
!
!       Color of the box perimeter
! lg02.lg02Work.Legend.lgBoxLineColor          : FOREGROUND
!
!       Width of the box perimeter
! lg02.lg02Work.Legend.lgBoxLineThicknessF     : 1.0
!
!       Dash pattern of the box perimeter
! lg02.lg02Work.Legend.lgBoxLineDashPattern    : 0
!
!       Length of dash segments of the box perimeter
! lg02.lg02Work.Legend.lgBoxLineDashSegLenF    : 0.15
!
! ------------------------
...
! lg02.lg02Work.Legend.lgDrawLabels              : 1
!
...
! lg02.lg02Work.Legend.lgLabelPosition           : RIGHT
!
!       Angle at which the scale labels are drawn
! lg02.lg02Work.Legend.lgLabelAngleF             : 0.0
!
...
! lg02.lg02Work.Legend.lgLabelAlignment          : BOXCENTERS
!
!       Direction in which scale labels are drawn (UP,DOWN,ACROSS)
!       Normal direction is across for all axes.
! lg02.lg02Work.Legend.lgLabelDirection          : ACROSS
!
!       How label text is justified in a text extent rectangle
! lg02.lg02Work.Legend.lgLabelJust               : CENTERCENTER
!
!       The font style to use for labels
lg02.lg02Work.Legend.lgLabelFont               : 25
!
!       The color for label text
! lg02.lg02Work.Legend.lgLabelFontColor          : FOREGROUND
!
!       The NDC (0. to 1.) height of the label text
lg02.lg02Work.Legend.lgLabelFontHeightF        : 0.03
!
!       The height to width aspect ratio of label characters
! lg02.lg02Work.Legend.lgLabelFontAspectF        : 1.0
!
!       The width of the lines that form the text outline
! lg02.lg02Work.Legend.lgLabelFontThicknessF      : 1.0
!
!       The degree of quality of the text to be written (LOW,MEDIUM,HIGH)
! lg02.lg02Work.Legend.lgLabelFontQuality         : HIGH
!
!       The spacing between characters of the text to be written
! lg02.lg02Work.Legend.lgLabelConstantSpacingF    : 0.0
!
!       A process for accessing the many characters of the default
!       pwritx font.
! lg02.lg02Work.Legend.lgLabelFuncCode            : :
!
!       The stride between labeled bars
! lg02.lg02Work.Legend.lgLabelStride             : 1
!
!       Fractional distance between the box and the label
! lg02.lg02Work.Legend.lgLabelOffsetF            : 0.
!
!       An array of label strings
! lg02.lg02Work.Legend.lgLabelStrings            : Label_
!
! ----------------
! THE LEGEND ITEMS
! ----------------
...
! lg02.lg02Work.Legend.lgMonoItemThickness      : True
!
!       ItemThickness has not been implemented yet
! lg02.lg02Work.Legend.lgItemThickness          :
!
!       Each item is assigned a line or glyph thickness.
! lg02.lg02Work.Legend.lgItemThicknesses        : NULL
!
!       When set True, all items in the Legend are given a line
!       label or glyph height equal to that specified in the first
!       element of array ItemTextHeights.
! lg02.lg02Work.Legend.lgMonoItemTextHeight     : True
!
!       ItemTextHeight has not been implemented yet
! lg02.lg02Work.Legend.lgItemTextHeight         :
!
!       Each item is assigned a line label or glyph height in NDCs.
! lg02.lg02Work.Legend.lgItemTextHeights        : NULL
!
!       When set True, all items are given a single color which is
!       in element one of array ItemStringColors.
! lg02.lg02Work.Legend.lgMonoItemStringColor     : True
!
!       ItemStringColor has not been implemented yet
! lg02.lg02Work.Legend.lgItemStringColor         :
!
!       Each item is assigned a color index of the HLU color table.
! lg02.lg02Work.Legend.lgItemStringColors        : NULL
!
!       A boolean flag determining whether to draw internal line
!       labels within Legend line items.
! lg02.lg02Work.Legend.lgDrawLineLabels          : True
!
!       The length in NDC units of the dash pattern used for Legend
!       line items.
! lg02.lg02Work.Legend.lgLineDashSegLenF         : 0.15
!
!       The font type to use for item line labels or marker glyphs.
lg02.lg02Work.Legend.lgItemStringFont            : 25
!
!   The height to width aspect ratio of item characters
! lg02.lg02Work.Legend.lgItemStringFontAspectF     : 1.0
!
!   The width of the lines that form the text outline
lg02.lg02Work.Legend.lgItemStringFontThicknessF  : 2.0
!
!   The degree of quality of the text to be written (LOW,MEDIUM,HIGH)
! lg02.lg02Work.Legend.lgItemStringFontQuality     : HIGH
!
!   The spacing between characters of the text to be written
! lg02.lg02Work.Legend.lgItemStringConstantSpacingF: 0.0
!
!   A process for accessing the many characters of the default
!   pwritx font.
! lg02.lg02Work.Legend.lgItemStringFuncCode        : :
!
