...
! *lg03Work.Legend.lgLegend              : True
!
!       Is title and label sizing to be done automatically
! *lg03Work.Legend.lgAutoManage          : True
!
!       Should the legend be HORIZONTAL or VERTICAL
! *lg03Work.Legend.lgOrientation         : VERTICAL
!
...
!       CENTERRIGHT
!       BOTTOMRIGHT
! *lg03Work.Legend.lgJustification       : BOTTOMLEFT
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! *lg03Work.Legend.lgLeftMarginF         : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! *lg03Work.Legend.lgRightMarginF        : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! *lg03Work.Legend.lgBottomMarginF       : .05
!
!       Distance from Legend perimeter to the Legend information
!       as a fraction of the smaller perim dimension.
! *lg03Work.Legend.lgTopMarginF          : .05
!
! ------------------
! THE LEGEND TITLE
! ------------------
...
! *lg03Work.Legend.lgTitleDirection       : ACROSS
!
...
!       CENTERRIGHT
!       BOTTOMRIGHT
! *lg03Work.Legend.lgTitleJust           : CENTERCENTER
!
...
!
*lg03Work.Legend.lgTitleFont            : 25
!
...
! *lg03Work.Legend.lgDrawPerim           : 1
!
!       Color of the legend perim
! *lg03Work.Legend.lgPerimColor          : FOREGROUND
!
!       Fill sytle of the legend perim
! *lg03Work.Legend.lgPerimFill           : FOREGROUND
!
!       Fill color of the legend perim
! *lg03Work.Legend.lgPerimFillColor      : FOREGROUND
!
!       Width of the legend perim
! *lg03Work.Legend.lgPerimThicknessF     : 1.0
!
!       Dash pattern of the legend perim
! *lg03Work.Legend.lgPerimDashPattern    : 0
!
!       Length of dash segments of the legend perim
! *lg03Work.Legend.lgPerimDashSegLenF    : 0.15
!
! ------------------------
...
*lg03Work.Legend.lgBoxBackground       : 1
!
!       A relative box width.  0. = no width, 1. = touching boxes
! *lg03Work.Legend.lgBoxMajorExtentF     : 1.0
!
!       A relative box length in a box + label pair.
!       If set to 1.0 it crowds out the label.
! *lg03Work.Legend.lgBoxMinorExtentF     : 0.33
!
!       Draw the box perimeters  (0 is off, 1 is on)
! *lg03Work.Legend.lgDrawBoxLines        : 0
!
!       Color of the box perimeter
! *lg03Work.Legend.lgBoxLineColor          : FOREGROUND
!
!       Width of the box perimeter
! *lg03Work.Legend.lgBoxLineThicknessF     : 1.0
!
!       Dash pattern of the box perimeter
! *lg03Work.Legend.lgBoxLineDashPattern    : 0
!
!       Length of dash segments of the box perimeter
! *lg03Work.Legend.lgBoxLineDashSegLenF    : 0.15
!
! ------------------------
...
! *lg03Work.Legend.lgDrawLabels              : 1
!
...
! *lg03Work.Legend.lgLabelPosition           : RIGHT
!
!       Angle at which the scale labels are drawn
! *lg03Work.Legend.lgLabelAngleF             : 0.0
!
...
! *lg03Work.Legend.lgLabelAlignment          : BOXCENTERS
!
!       Direction in which scale labels are drawn (UP,DOWN,ACROSS)
!       Normal direction is across for all axes.
! *lg03Work.Legend.lgLabelDirection          : ACROSS
!
!       How label text is justified in a text extent rectangle
! *lg03Work.Legend.lgLabelJust               : CENTERCENTER
!
!       The font style to use for labels
*lg03Work.Legend.lgLabelFont               : 25
!
!       The color for label text
! *lg03Work.Legend.lgLabelFontColor          : FOREGROUND
!
!       The NDC (0. to 1.) height of the label text
! *lg03Work.Legend.lgLabelFontHeightF        : .02
!
!       The height to width aspect ratio of label characters
! *lg03Work.Legend.lgLabelFontAspectF        : 1.0
!
!       The width of the lines that form the text outline
! *lg03Work.Legend.lgLabelFontThicknessF      : 1.0
!
!       The degree of quality of the text to be written (LOW,MEDIUM,HIGH)
! *lg03Work.Legend.lgLabelFontQuality         : HIGH
!
!       The spacing between characters of the text to be written
! *lg03Work.Legend.lgLabelConstantSpacingF    : 0.0
!
!       A process for accessing the many characters of the default
!       pwritx font.
! *lg03Work.Legend.lgLabelFuncCode            : :
!
!       The stride between labeled bars
! *lg03Work.Legend.lgLabelStride             : 1
!
!       Fractional distance between the box and the label
! *lg03Work.Legend.lgLabelOffsetF            : 0.
!
!       An array of label strings
! *lg03Work.Legend.lgLabelStrings            : Label_
!
! ----------------
! THE LEGEND ITEMS
! ----------------
...
! *lg03Work.Legend.lgItemStringColors        : NULL
!
!       A boolean flag determining whether to draw internal line
!       labels within Legend line items.
! *lg03Work.Legend.lgDrawLineLabels          : True
!
!       The length in NDC units of the dash pattern used for Legend
!       line items.
! *lg03Work.Legend.lgLineDashSegLenF         : 0.15
!
!       The font type to use for item line labels or marker glyphs.
*lg03Work.Legend.lgItemStringFont            : 1
!
!   The height to width aspect ratio of item characters
! *lg03Work.Legend.lgItemStringFontAspectF     : 1.0
!
!   The width of the lines that form the text outline
*lg03Work.Legend.lgItemStringFontThicknessF  : 6.0
!
!   The degree of quality of the text to be written (LOW,MEDIUM,HIGH)
! *lg03Work.Legend.lgItemStringFontQuality     : HIGH
!
!   The spacing between characters of the text to be written
! *lg03Work.Legend.lgItemStringConstantSpacingF: 0.0
!
!   A process for accessing the many characters of the default
!   pwritx font.
! *lg03Work.Legend.lgItemStringFuncCode        : :
!
