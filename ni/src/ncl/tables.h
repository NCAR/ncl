...
GribTable models[] = {
	...
	{96, "Global Forecast System Model (formerly known as the Aviation), T382 - Forecast hours 00-180, T190 - Forecast hours 192-384"},
	...
	{111, "Eta model, generic resolution (Used in SREF processing)"},
	{112, "WRF-NMM model, generic resolution (Used in various runs) NMM=Nondydrostatic Mesoscale Model (NCEP)"},
        ...
        {115, "Downscaled GFS from Eta eXtension"},
