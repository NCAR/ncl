...
{163, "Particulate matter (fine)", "log10(mcg/m^3)", "LPMTF"},
{164, "Integrated column particulate matter (fine)", "log10(mcg/m^3)", "LIPMF"},
...
{194, "Tropical cyclone heat potential", "J/m^2K", "TCHP"},
...
{216, "Simulated brightness temperature for GOES12, channel 6", "K", "SBT126"},
...
{233, "PM 2.5 daily max from 1-hour average", "mcg/m^3", "PDMAX1"},
{234, "PM 2.5 daily max from 24-hour average", "mcg/m^3", "PDMX24"},
{235, "Hourly maximum of simulated reflectivity at 1 km AGL", "dbZ", "MAXREF"},
{236, "Hourly maximum of updraft helicity over layer 2km to 5 km AGL", "m^2/s^2", "MXUPHL"},
{237, "Hourly maximum of upward vertical velocity in the lowest 400hPa", "m/s", "MAXUVV"},
{238, "Hourly maximum of downward vertical velocity in the lowest 400hPa", "m/s", "MAXDVV"},
{239, "Hourly maximum of column vertical integrated graupel", "kg/m^2", "MAXVIG"},
{240, "Radar echo top (18.3 DBZ)", "m", "RETOP"},
{241, "Ventilation rate", "m^2/s", "VRATE"},
...
{250, "Haines index", "non-dim", "HINDEX"},
{251, "Difference between 2 states in total energy norm", "J/kg", "DIFTEN"},
{252, "Pseudo-precipitation", "kg/m^2", "PSPCP"},
{253, "U component of hourly maximum 10m wind speed", "m/s", "MAXUW"},
{254, "V component of hourly maximum 10m wind speed", "m/s", "MAXVW"}
};
