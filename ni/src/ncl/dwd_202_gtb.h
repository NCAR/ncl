...
{2,   "jonswap parameter alpha",     "index", "SEEG_ALPHA"},
{3,   "jonswap parameter gamma",     "index", "SEEG_GAMMA"},
{4,   "Seegang direction",   "degree true", "SEEG_DIR"},
{5,   "Seegang energy densitiy",     "(m**2)*(s**2)", "SEEG_ENERG"},
{6,   "Seegang ice mask",    "index", "SEEG_ICEMK"},
...
{46,  "standard deviation of subgrid scale height"   "m", "SSO_STDH"},
{47,  "anisotropy of topography",    "index", "SSO_GAMMA"},
{48,  "angle between principal axis of orography and global east",   "index", "SSO_SIGMA"},
{49,  "mean slope of subgrid scale orography",   "index", "SLOPE_SSO"},
...
{55,  "fraction of inland lake water", "index", "FR_LAKE"},
{56,  "surface emissivity",  "index", "SURF_EMISS"},
{57,  "soil type",    "index", "SOILTYP"},
{58,  "soil color",  "index", "SOIL_COLOR"},
{59,  "soil drainage",   "index", "SOIL_DRAIN"},
{60,  "ground water table",  "m", "GROUND_WAT"},
{61,  "leaf area index",  "index", "LAI"},
{62,  "root depth"  "m", "ROOTDP"},
{63,  "root density",    "index", "ROOT_DENS"},
{64,  "air pressure of ozone maximum",    "Pa", "HMO3"},
{65,  "vertical integrated ozone amount",   "Pa", "VIO3"},
{66,  "land-sea mask",   "index", "LD_SEA_MSK"},
{67,  "vegetation area fraction maximum",   "index", "PLCOV_MX"},
{68,  "vegetation area fraction minimum",    "index", "PLCOV_MN"},
{69,  "leaf area index maximum",     "index", "LAI_MX"},
{70,  "leaf area index minimum",  "index", "LAI_MN"},
...
{75,  "ground fraction covered by evergreen forest",     "index", "FOR_E"},
{76,  "ground fraction covered by deciduous forest",     "index", "FOR_D"},
...
{104, "tendency of water vapor",     "s-1", "DVQDT"},
{105, "surface flux of water vapor",     "s-1", "QVSFLX"},
...
{111, "budget values",   "index", "BUDGET_VAL"},
{112, "scale factor",    "index", "SCALE_FACT"},
{113, "Coriolis parameter",  "s-1", "FC"},
{114, "latitude",    "radian", "RLAT"},
{115, "longitude",   "radian", "RLON"},
{116, "relaxation factor (lateral boundary, LAM)",   "index", "RELAX_FACT"},
{117, "climatic sea surface temp interpolated in time",  "degr C", "CLIMSSTINT"},
{118, "potential vorticity",     "K*m**2/(s*kg)", "POT_VORTIC"},
{119, "log surface pressure",    "index", "LN_PS"},
{121, "integrated total atmospheric refractivity",  "non-dim", "ZTD"},
{122, "integrated wet atmospheric refractivity",    "non-dim", "ZWD"},
...
{180, "ozone mass mixing ratio",     "kg kg-1", "O3"},
...
{204, "Cs137-dry deposition",    "Bq/m**2", "CS137_DRYD"},
...
{243, "UV_Index cloudless (F), daily maximum",   "index", "UV_INDMAXF"},
...
{247, "total column ozone (Gesamtozon), Dobson Unit", "DU", "GESAMT_O3"},
{248, "UV_Index clouded (W), daily maximum",     "index", "UV_INDMAXW"},
{249, "time of UV_Index maximum",    "h UTC", "H_UV_INDMX"},
};
