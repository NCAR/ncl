...
{192, "m**2", "NWSE component subgrid orographic variance", "NWOV"},
{193, "m**2", "NESW component subgrid orographic variance", "NEOV"},
...
{212, "TOA incident solar radiation", "W m**-2 s", "SI"},
