...
{176, "Surface solar radiation (net)", "J m**-2 s", "SSR"},
{177, "Surface thermal radiation (net)", "J m**-2 s", "STR"},
{178, "Top solar radiation (net)", "J m**-2 s", "TSR"},
{179, "Top thermal radiation (net)", "J m**-2 s", "TTR"},
{180, "East/West surface stress", "N m**-2 s", "EWSS"},
{181, "North/South surface stress", "N m**-2 s", "NSSS"},
{182, "Evaporation (surface)", "m (of water)", "E"},
{205, "Runoff (total)", "m", "RO"},
};
