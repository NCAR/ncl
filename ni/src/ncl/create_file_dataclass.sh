...
-e "s/OPER/\.eq\./g" \
-e "s/FUNCNAME/Eq/g" \
MultiDValSimpleOpTemplate.c.sed > tmp.nclfile


sed \
-e "s/DATATYPE/nclfile/g" \
MultiDValSelectFuncsTemplate.c.sed >> tmp.nclfile
...
sed \
-e 's/FIELDNAME/nclfileval/' \
-e 's/DATATYPE/nclfile/g' \
-e '/DSPECIFIC/d' \
NclMultiDValData.h.sed >! NclMultiDValnclfileData.h
