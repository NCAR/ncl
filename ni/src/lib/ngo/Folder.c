...
static void Layout(f, resizeIfNeeded)
XmLFolderWidget f;
int resizeIfNeeded;
	{
	Window win;
...
static void LayoutTopBottom(f, resizeIfNeeded)
XmLFolderWidget f;
int resizeIfNeeded;
	{
	Display *dpy;
...
static void LayoutLeftRight(f, resizeIfNeeded)
XmLFolderWidget f;
int resizeIfNeeded;
	{
	Display *dpy;
...
static Boolean ServerDrawsArcsLarge(dpy, debug)
Display *dpy;
int debug;
	{
	Pixmap pixmap;
...
static Boolean CvtStringToFolderResizePolicy(dpy, args, narg, fromVal,
	toVal, data)
Display *dpy;
XrmValuePtr args;
Cardinal *narg;
