...
static void ApplyVisibleRows();
static void ApplyVisibleCols();
static void VisPosChanged();
...
static Boolean CvtStringToRowColType();
...
static void SetSimpleHeadings();
static void SetSimpleWidths();

static void GetRowValueMask();
static void _GetRowValueMask();
static void GetRowValue();
static void _GetRowValue();
static int SetRowValues();
static int _SetRowValues();

static void GetColumnValueMask();
static void _GetColumnValueMask();
static void GetColumnValue();
static void _GetColumnValue();
static int SetColumnValues();
static int _SetColumnValues();
...
static int SetCellValuesResize();
static int _SetCellValuesResize();
...
static char *CvtXmStringToStr();
static XmLGridWidget WidgetToGrid();
...
static XmLGridRow XmLGridRowNew();
static void XmLGridRowFree();
static XmLGridRow _GridRowNew();
static void _GridRowFree();
static XmLArray XmLGridRowCells();
static int XmLGridRowGetPos();
static int XmLGridRowGetVisPos();
static Boolean XmLGridRowIsHidden();
static Boolean XmLGridRowIsSelected();
static void XmLGridRowSetSelected();
static void XmLGridRowSetVisPos();
static int XmLGridRowHeightInPixels();
static void XmLGridRowHeightChanged();

static XmLGridColumn XmLGridColumnNew();
static void XmLGridColumnFree();
static XmLGridColumn _GridColumnNew();
static void _GridColumnFree();
static int XmLGridColumnGetPos();
static int XmLGridColumnGetVisPos();
static Boolean XmLGridColumnIsHidden();
static Boolean XmLGridColumnIsSelected();
static void XmLGridColumnSetSelected();
static void XmLGridColumnSetVisPos();
static int XmLGridColumnWidthInPixels();
static void XmLGridColumnWidthChanged();

static XmLGridCell XmLGridCellNew();
static void XmLGridCellFree();
static int XmLGridCellAction();
static int _GridCellAction();
static XmLGridCellRefValues *XmLGridCellGetRefValues();
static void XmLGridCellSetRefValues();
static void XmLGridCellDerefValues();
static Boolean XmLGridCellInRowSpan();
static Boolean XmLGridCellInColumnSpan();
static Boolean XmLGridCellIsSelected();
static Boolean XmLGridCellIsValueSet();
static void XmLGridCellSetValueSet();
...
static Boolean XmLGridCellGetToggle();
static void XmLGridCellSetPixmap();
...
static int _XmLGridCellGetHeight();
static int _XmLGridCellGetWidth();
static void _XmLGridCellFreeValue();
...
static void ApplyVisibleRows(g)
XmLGridWidget g;
	{
	XtWidgetGeometry req;
	XmLGridCellRefValues *cellValues;
...
static void ApplyVisibleCols(g)
XmLGridWidget g;
	{
	XtWidgetGeometry req;
	XmLGridCellRefValues *cellValues;
...
static void VisPosChanged(g, isVert)
XmLGridWidget g;
int isVert;
	{
	if (isVert)
...
static int ScrollRowBottomPos(g, row)
XmLGridWidget g;
int row;
	{
	int r, h, height;
...
static int ScrollColRightPos(g, col)
XmLGridWidget g;
int col;
	{
	int c, w, width;
...
static XmLGridCell GetCell(g, row, col)
XmLGridWidget g;
int row, col;
	{
	XmLGridRow rowp;
...
static Boolean CvtStringToRowColType(dpy, args, narg, fromVal, toVal, data)
Display *dpy;
XrmValuePtr args;
Cardinal *narg;
XrmValuePtr fromVal, toVal;
...
static void SetSimpleHeadings(g, data)
XmLGridWidget g;
char *data;
	{
	char *c;
...
static void SetSimpleWidths(g, data)
XmLGridWidget g;
char *data;
	{
	XmLGridColumn colp;
...
static void GetRowValueMask(g, s, mask)
XmLGridWidget g;
char *s;
long *mask;
	{
...
static void _GetRowValueMask(g, s, mask)
XmLGridWidget g;
char *s;
long *mask;
	{
...
static void GetRowValue(g, row, value, mask)
XmLGridWidget g;
XmLGridRow row;
XtArgVal value;
long mask;
...
/* Only to be called through Grid class */
static void _GetRowValue(g, row, value, mask)
XmLGridWidget g;
XmLGridRow row;
XtArgVal value;
long mask;
...
/* Only to be called through Grid class */
static int _SetRowValues(g, row, mask)
XmLGridWidget g;
XmLGridRow row;
long mask;
	{
...
static void GetColumnValueMask(g, s, mask)
XmLGridWidget g;
char *s;
long *mask;
	{
...
/* Only to be called through Grid class */
static void _GetColumnValueMask(g, s, mask)
XmLGridWidget g;
char *s;
long *mask;
	{
...
static void GetColumnValue(g, col, value, mask)
XmLGridWidget g;
XmLGridColumn col;
XtArgVal value;
long mask;
...
/* Only to be called through Grid class */
static void _GetColumnValue(g, col, value, mask)
XmLGridWidget g;
XmLGridColumn col;
XtArgVal value;
long mask;
...
/* Only to be called through Grid class */
static int _SetColumnValues(g, col, mask)
XmLGridWidget g;
XmLGridColumn col;
long mask;
	{
...
static void CellValueGetMask(s, mask)
char *s;
long *mask;
	{
...
static int SetCellValuesResize(g, row, col, cell, mask)
XmLGridWidget g;
XmLGridRow row;
XmLGridColumn col;
XmLGridCell cell;
...
static int _SetCellValuesResize(g, row, col, cell, mask)
XmLGridWidget g;
XmLGridRow row;
XmLGridColumn col;
XmLGridCell cell;
...
static char *CopyDataCreate(g, selected, row, col, nrow, ncol)
XmLGridWidget g;
int selected;
int row, col;
int nrow, ncol;
...
static Boolean Copy(g, time, selected, row, col, nrow, ncol)
XmLGridWidget g;
Time time;
int selected;
int row, col;
...
static Boolean Paste(g, row, col)
XmLGridWidget g;
int row, col;
	{
	Display *dpy;
...
static char *CvtXmStringToStr(str)
XmString str;
	{
...
static XmLGridWidget WidgetToGrid(w, funcname)
Widget w;
char *funcname;
	{
	char buf[256];
...
static XmLGridRow XmLGridRowNew(grid)
Widget grid;
	{
...
static void XmLGridRowFree(grid, row)
Widget grid;
XmLGridRow row;
	{
...
static XmLArray XmLGridRowCells(row)
XmLGridRow row;
	{
	return row->grid.cellArray;
	}

static int XmLGridRowGetPos(row)
XmLGridRow row;
	{
	return row->grid.pos;
	}

static int XmLGridRowGetVisPos(row)
XmLGridRow row;
	{
	return row->grid.visPos;
	}

static Boolean XmLGridRowIsHidden(row)
XmLGridRow row;
	{
	if (!row->grid.height)
		return True;
...
static Boolean XmLGridRowIsSelected(row)
XmLGridRow row;
	{
...
static void XmLGridRowSetVisPos(row, visPos)
XmLGridRow row;
int visPos;
	{
...
static int XmLGridRowHeightInPixels(row)
XmLGridRow row;
	{
	int i, count;
...
static void XmLGridRowHeightChanged(row)
XmLGridRow row;
	{
	row->grid.heightInPixelsValid = 0;
	}
...
static XmLGridColumn XmLGridColumnNew(grid)
Widget grid;
	{
...
static void XmLGridColumnFree(grid, column)
Widget grid;
XmLGridColumn column;
	{
...
/* Only to be called through Grid class */
static void _GridColumnFree(column)
XmLGridColumn column;
	{
...
static int XmLGridColumnGetPos(column)
XmLGridColumn column;
	{
	return column->grid.pos;
	}

static int XmLGridColumnGetVisPos(column)
XmLGridColumn column;
	{
	return column->grid.visPos;
	}

static Boolean XmLGridColumnIsHidden(column)
XmLGridColumn column;
	{
...
static Boolean XmLGridColumnIsSelected(column)
XmLGridColumn column;
	{
...
static void XmLGridColumnSetVisPos(column, visPos)
XmLGridColumn column;
int visPos;
	{
...
static int XmLGridColumnWidthInPixels(column)
XmLGridColumn column;
	{
	int i, count;
...
static void XmLGridColumnWidthChanged(column)
XmLGridColumn column;
	{
	column->grid.widthInPixelsValid = 0;
	}
...
static void XmLGridCellFree(grid, cell)
Widget grid;
XmLGridCell cell;
	{
	XmLGridCallbackStruct cbs;
...
static int XmLGridCellAction(cell, w, cbs)
XmLGridCell cell;
Widget w;
XmLGridCallbackStruct *cbs;
	{
...
/* Only to be called through Grid class */
static int _GridCellAction(cell, w, cbs)
XmLGridCell cell;
Widget w;
XmLGridCallbackStruct *cbs;
	{
...
static XmLGridCellRefValues *XmLGridCellGetRefValues(cell)
XmLGridCell cell;
	{
	return cell->cell.refValues;
	}

static void XmLGridCellSetRefValues(cell, values)
XmLGridCell cell;
XmLGridCellRefValues *values;
	{
	values->refCount++;
...
static void XmLGridCellDerefValues(values)
XmLGridCellRefValues *values;
	{
	if (!values)
		return;
...
static Boolean XmLGridCellInRowSpan(cell)
XmLGridCell cell;
	{
...
static Boolean XmLGridCellInColumnSpan(cell)
XmLGridCell cell;
	{
...
static Boolean XmLGridCellIsSelected(cell)
XmLGridCell cell;
	{
...
static Boolean XmLGridCellIsValueSet(cell)
XmLGridCell cell;
	{
...
static XmString XmLGridCellGetString(cell)
XmLGridCell cell;
	{
	XmString str;
...
static Boolean XmLGridCellGetToggle(cell)
XmLGridCell cell;
	{
	Boolean toggled;
...
static void XmLGridCellSetPixmask(cell, pixmask)
XmLGridCell cell;
Pixmap pixmask;
	{
	XmLGridCellPixmap *pix;
...
static XmLGridCellPixmap *XmLGridCellGetPixmap(cell)
XmLGridCell cell;
	{
	XmLGridCellPixmap *pix;
...
void _XmLGridCellDrawBackground(cell, w, clipRect, ds)
XmLGridCell cell;
Widget w;
XRectangle *clipRect;
XmLGridDrawStruct *ds;
...
/* Only to be called by XmLGridCellAction() */
void _XmLGridCellDrawBorders(cell, w, clipRect, ds)
XmLGridCell cell;
Widget w;
XRectangle *clipRect;
XmLGridDrawStruct *ds;
...
/* Only to be called by XmLGridCellAction() */
void _XmLGridCellDrawValue(cell, w, clipRect, ds)
XmLGridCell cell;
Widget w;
XRectangle *clipRect;
XmLGridDrawStruct *ds;
...
/* Only to be called by XmLGridCellAction() */
static int _XmLGridCellBeginTextEdit(cell, w, clipRect)
XmLGridCell cell;
Widget w;
XRectangle *clipRect;
	{
...
/* Only to be called by XmLGridCellAction() */
static void _XmLGridCellCompleteTextEdit(cell, w)
XmLGridCell cell;
Widget w;
	{
	Widget text;
...
/* Only to be called by XmLGridCellAction() */
static void _XmLGridCellInsertText(cell, w)
XmLGridCell cell;
Widget w;
	{
	char *s;
...
/* Only to be called by XmLGridCellAction() */
static int _XmLGridCellGetHeight(cell, row)
XmLGridCell cell;
XmLGridRow row;
	{
	XmLGridCellPixmap *pix;
...
/* Only to be called by XmLGridCellAction() */
static int _XmLGridCellGetWidth(cell, col)
XmLGridCell cell;
XmLGridColumn col;
	{
	XmLGridCellPixmap *pix;
...
/* Only to be called by XmLGridCellAction() */
static void _XmLGridCellFreeValue(cell)
XmLGridCell cell;
	{
	int type;
	XmLGridCellIcon *icon;
