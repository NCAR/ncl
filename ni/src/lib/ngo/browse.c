...
)
{
...
#if 0
	unsigned char btnout_bits[] = {
		0xfe,0xff,0x00,0x80,0xfc,0xbf,0xfc,0xbf,0x04,0xb0,0xf4,0xb7,
		0xf4,0xb7,0xf4,0xb7,0xf4,0xb7,0xf4,0xb7,0xf4,0xb7,0xf4,0xb7,
		0x04,0xb0,0xfc,0xbf,0x00,0xa0,0x00,0x80};
	unsigned char btnin_bits[] = {
		0x00,0x00,0x01,0x00,0xfd,0x3f,0x0d,0x20,0xed,0x2f,0xed,0x2f,
		0xed,0x2f,0xed,0x2f,0xed,0x2f,0xed,0x2f,0xed,0x2f,0x0d,0x20,
		0xfd,0x3f,0xfd,0x7f,0x01,0x00,0xff,0xff};
#endif
	unsigned char btnout12_bits[] = {
		0xff,0x07,0xff,0x03,0xab,0x02,0x57,0x01,0xab,0x02,0x57,0x01,
		0xab,0x02,0x57,0x01,0xab,0x02,0x57,0x01,0x01,0x00,0x00,0x00};
	unsigned char btnin12_bits[] = {
		0x00,0xf8,0x00,0xfc,0x54,0xfd,0xa8,0xfe,0x54,0xfd,0xa8,0xfe,
		0x54,0xfd,0xa8,0xfe,0x54,0xfd,0xa8,0xfe,0xfe,0xff,0xff,0xff};

	unsigned char btnout_bits[] = {
		0xff,0xff,0xff,0x7f,0xff,0x3f,0x57,0x15,0xaf,0x0a,0x57,0x15,
		0xaf,0x0a,0x57,0x15,0xaf,0x0a,0x57,0x15,0xaf,0x0a,0x57,0x15,
		0xaf,0x0a,0x07,0x00,0x03,0x00,0x01,0x00};
	unsigned char btnin_bits[] = {
		0x00,0x00,0x00,0x80,0x00,0xc0,0xa8,0xea,0x50,0xf5,0xa8,0xea,
		0x50,0xf5,0xa8,0xea,0x50,0xf5,0xa8,0xea,0x50,0xf5,0xa8,0xea,
		0x50,0xf5,0xf8,0xff,0xfc,0xff,0xfe,0xff};
	...
	browse->browse.pixmaps.button_out = XCreatePixmapFromBitmapData
		(XtDisplay(browse->go.shell),
		 XtWindow(browse->go.shell),
		 (char*)btnout12_bits,BTN_WIDTH,BTN_HEIGHT,
		 white,black,XcbGetDepth(browse->go.xcb));
	browse->browse.pixmaps.button_in = XCreatePixmapFromBitmapData
		(XtDisplay(browse->go.shell),
		 XtWindow(browse->go.shell),
		 (char*)btnin12_bits,BTN_WIDTH,BTN_HEIGHT,
		 white,black,XcbGetDepth(browse->go.xcb));
