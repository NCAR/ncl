C NCLFORTSTART
      SUBROUTINE DCOMPUTE_PI(PI,PRESSURE,NX,NY,NZ)
      IMPLICIT NONE
      INTEGER NX,NY,NZ
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_TK(TK,PRESSURE,THETA,NX)
      IMPLICIT NONE
      INTEGER NX
      DOUBLE PRECISION PI
...
C NCLFORTSTART
      SUBROUTINE DINTERP_3DZ(V3D,V2D,Z,LOC,NX,NY,NZ)
      IMPLICIT NONE
      INTEGER NX,NY,NZ
...
C NCLFORTSTART
      SUBROUTINE DZ_STAG(ZNEW,NX,NY,NZ,Z,NXZ,NYZ,NZZ,TERRAIN)
      IMPLICIT NONE
...
C NCLFORTSTART
      SUBROUTINE DINTERP_2D_XY(V3D,V2D,XY,NX,NY,NZ,NXY)
      IMPLICIT NONE
...
C NCLFORTSTART
      SUBROUTINE DINTERP_1D(V_IN,V_OUT,Z_IN,Z_OUT,NZ_IN,NZ_OUT)
      IMPLICIT NONE
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_SEAPRS(NX,NY,NZ,Z,T,P,Q,SEA_LEVEL_PRESSURE,
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_RH(QV,P,T,RH,NX)
...
C NCLFORTSTART
      SUBROUTINE DGET_IJ_LAT_LONG(LAT_ARRAY,LONG_ARRAY,LAT,LONGITUDE,IR,
     +                           JR,NX,NY)
      IMPLICIT NONE
      INTEGER NX,NY
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_UVMET(U,V,UVMET,LONGCA,LONGCB,FLONG,FLAT,
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_TD(TD,PRESSURE,QV_IN,NX,NY,NZ)
      IMPLICIT NONE
      INTEGER NX,NY,NZ
      DOUBLE PRECISION PRESSURE(NX,NY,NZ)
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_TD_2D(TD,PRESSURE,QV_IN,NX,NY)
      IMPLICIT NONE
      INTEGER NX,NY
...
C NCLFORTSTART
      SUBROUTINE DCOMPUTE_ICLW(ICLW,PRESSURE,QC_IN,NX,NY,NZ)
      IMPLICIT NONE
      INTEGER NX,NY,NZ
      DOUBLE PRECISION PRESSURE(NX,NY,NZ)
