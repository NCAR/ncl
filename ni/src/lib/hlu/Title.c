/*
 *      $Id: Title.c,v 1.7 1994-03-18 02:18:37 dbrown Exp $
 */
/************************************************************************
*									*
*			     Copyright (C)  1992			*
...
static NhlResource resources[] = {
	{NhlNtiDeltaF, NhlCtiDeltaF, NhlTFloat, sizeof(float),
		 Oset(delta), NhlTString,_NhlUSET( "1.5" )},
	{NhlNtiMainFontColor,NhlCtiTitleFontColors,NhlTInteger,sizeof(int),
		 Oset(main_font_color),NhlTImmediate,_NhlUSET((NhlPointer)1)},
	...
	{NhlNtiUseMainAttributes,NhlCtiUseMainAttributes, NhlTBoolean,
		 sizeof(NhlBoolean),
		 Oset(use_main_attributes),NhlTImmediate,_NhlUSET(False)},
	...
	{NhlNtiMainJust, NhlCtiTitleJust, NhlTInteger,sizeof(int),
		 Oset(main_just),NhlTImmediate,_NhlUSET((NhlPointer)4)},
	{NhlNtiMainFont, NhlCFont, NhlTFont, sizeof(NhlFont),
		 Oset(main_font),NhlTImmediate,_NhlUSET((NhlPointer)0)},
	{NhlNtiMainFontHeightF,NhlCtiTitleFontHeightsF,NhlTFloat,sizeof(float),
		 Oset(main_font_height), NhlTString,_NhlUSET("0.025")},
	{NhlNtiMainFontAspectF,NhlCtiTitleFontAspectsF,NhlTFloat,sizeof(float),
		 Oset(main_font_aspect), NhlTString,_NhlUSET("1.3125")},
	...
	{NhlNtiXAxisDirection,NhlCtiXAxisDirection,NhlTTextDirection,
		 sizeof(NhlTextDirection),
		 Oset(x_axis_direction), NhlTImmediate,
		 _NhlUSET((NhlPointer)NhlACROSS)},
	...
	{NhlNtiYAxisString, NhlCtiYAxisString,NhlTString,sizeof(char*),
		 ...
		 _NhlUSET((NhlPointer)YAxis)},
	{NhlNtiYAxisJust, NhlCtiTitleJust, NhlTInteger,sizeof(int),
		 Oset(y_axis_just),NhlTImmediate,_NhlUSET((NhlPointer)4 )},
	{NhlNtiYAxisFont, NhlCFont, NhlTFont, sizeof(NhlFont),
		 Oset(y_axis_font),NhlTImmediate,_NhlUSET((NhlPointer)0 )},
	{NhlNtiYAxisFontHeightF,NhlCtiTitleFontHeightsF,
		 NhlTFloat,sizeof(float),
		 Oset(y_axis_font_height), NhlTString,_NhlUSET("0.025")},
	{NhlNtiYAxisFontAspectF,NhlCtiTitleFontAspectsF,NhlTFloat,
		 sizeof(float),
		 Oset(y_axis_font_aspect), NhlTString,_NhlUSET("1.3125")},
	...
	{NhlNtiYAxisAngleF,NhlCtiTitleAnglesF,NhlTFloat, sizeof(float),
		 Oset(y_axis_angle), NhlTString,_NhlUSET("90.0")},
