/*
*      $Id: MapTransObj.c,v 1.7 1994-05-05 18:16:56 ethan Exp $
*/
/************************************************************************
*									*
*			     Copyright (C)  1992			*
...
{ NhlNmpRectLimitType, NhlCmpRectLimitType, NhlTString, sizeof(char*),
	...
	NhlTString,"MA",0,(NhlFreeFunc)NhlFree},
