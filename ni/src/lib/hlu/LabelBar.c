...
{NhlNlbBoxSizing, NhlClbBoxSizing, NhlTInteger,
	 ...
	 NhlTImmediate,_NhlUSET((NhlPointer) NhlLB_UNIFORMSIZING)},
...
{NhlNlbLabelAlignment, NhlClbLabelAlignment, NhlTInteger, 
	 ...
	 NhlTImmediate,_NhlUSET((NhlPointer) NhlLB_BOXCENTERS)},
...
{NhlNlbLabelFontColor, NhlClbLabelFontColor, NhlTInteger, 
	 ...
	 NhlTImmediate,_NhlUSET((NhlPointer) NhlLB_DEF_COLOR)},
