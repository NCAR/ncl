/*
 *      $Id: SubStyles.c,v 1.1 1996-02-26 21:46:08 dbrown Exp $
 */
/************************************************************************
*									*
*			     Copyright (C)  1992			*
...
/* Begin-documented-resources */
	...
	{NhlNgsFillScaleFactorF,NhlCFillScaleFactorF,NhlTFloat,
...
/* Begin-documented-resources */
	...
	{NhlNgsFontThicknessF, NhlCFontThicknessF, NhlTFloat, sizeof(float),
		Oset(font_thickness),
		NhlTProcedure,_NhlUSET((NhlPointer)_NhlResUnset) ,0,NULL},
	{NhlNgsConstantSpacingF,NhlCConstantSpacingF,NhlTFloat,sizeof(float),
		Oset(constant_spacing),
		NhlTProcedure,_NhlUSET((NhlPointer)_NhlResUnset),0,NULL},
	{NhlNgsDirection,NhlCTextDirection,NhlTTextDirection,
		sizeof(NhlTextDirection),
		Oset(direction),
		NhlTProcedure,_NhlUSET((NhlPointer)_NhlResUnset),0,NULL},
	{NhlNgsFuncCode, NhlCFuncCode, NhlTCharacter, 
		sizeof(char),
		Oset(func_code),
