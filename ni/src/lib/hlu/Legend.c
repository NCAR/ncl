...
{NhlNlgItemIndexes, NhlClgItemIndexes, NhlT1DIntGenArray,
...
{NhlNlgItemStrings, NhlClgItemStrings, NhlT1DStringGenArray,
	 sizeof(NhlPointer), 
...
{NhlNlgMonoItemType, NhlClgMonoItemType, NhlTBoolean,
	 ...
	 NhlTImmediate, _NhlUSET((NhlPointer) True),0,NULL},
{NhlNlgItemTypes, NhlClgItemTypes, NhlT1DIntGenArray,
...
{NhlNlgItemColors, NhlClgItemColors, NhlT1DIntGenArray,
...
{NhlNlgMonoItemThickness, NhlClgMonoItemThickness, NhlTBoolean,
	 ...
	 NhlTImmediate, _NhlUSET((NhlPointer) True),0,NULL},
{NhlNlgItemThicknesses, NhlClgItemThicknesses, NhlT1DFloatGenArray,
	 sizeof(NhlPointer), 
...
{NhlNlgMonoItemTextHeight, NhlClgMonoItemTextHeight, NhlTBoolean,
	 ...
	 NhlTImmediate, _NhlUSET((NhlPointer) True),0,NULL},
{NhlNlgItemTextHeights, NhlClgItemTextHeights, NhlT1DFloatGenArray,
	 sizeof(NhlPointer), 
...
{NhlNlgLabelStrings, NhlClgLabelStrings, NhlT1DStringGenArray,
	 ...
	 NhlTImmediate, _NhlUSET((NhlPointer) NULL),0,(NhlFreeFunc)NhlFreeGenArray},
{NhlNlgItemPositions, NhlClgItemPositions, NhlT1DFloatGenArray,
...
{NhlNlgMonoItemStringColor, NhlClgMonoItemStringColor, NhlTBoolean,
	 ...
	 NhlTImmediate, _NhlUSET((NhlPointer) False),0,NULL},
{NhlNlgItemStringColors, NhlClgItemStringColors, NhlT1DIntGenArray,
	 sizeof(NhlPointer), 
