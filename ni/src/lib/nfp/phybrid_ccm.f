      SUBROUTINE DPHYBRID(P0,HYA,HYB,PSFC,MLON,NLAT,KLEV,PHY)
...
c          phy    - pressure at hybrid levels [Pa]
      ...
      DOUBLE PRECISION P0,HYA(KLEV),HYB(KLEV),PSFC(MLON,NLAT)
...
C NCLFORTSTART
      SUBROUTINE DDPHYBRID(P0,HYA,HYB,PSFC,MLON,NLAT,KLEV,DPHY)
      IMPLICIT NONE
