 ...
 */
      ...
      {
        NhlPError(NhlFATAL,NhlEUNKNOWN,"trvsphx: nlona = %ld is greater than INT_MAX", nlona);
        return(NhlFATAL);
      }
 ...
 */
      ...
      {
        NhlPError(NhlFATAL,NhlEUNKNOWN,"df2foshv: ilon = %ld is greater than INT_MAX", ilon);
        return(NhlFATAL);
      }
      if (ier) {
