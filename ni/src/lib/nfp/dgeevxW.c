 ...
 * Arguments #1-5
 */
  NclQuark *balanc, *jobvl, *jobvr, *sense;
 ...
 */
  balanc = (NclQuark*)NclGetArgValue(
           1,
           6,
           NULL,
           NULL,
