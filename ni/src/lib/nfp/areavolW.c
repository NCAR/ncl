 ...
 */
  ...
  int ndims_wgtx, dsizes_wgtx[NCL_MAX_DIMENSIONS], has_missing_wgtx;
  int ndims_wgty, dsizes_wgty[NCL_MAX_DIMENSIONS], has_missing_wgty;
 ...
 */
  int i, index_x, nx, ny, nxny, total_size_x, total_leftmost;
 ...
 */
  ...
  int ndims_wgtx, dsizes_wgtx[NCL_MAX_DIMENSIONS], has_missing_wgtx;
  int ndims_wgty, dsizes_wgty[NCL_MAX_DIMENSIONS], has_missing_wgty;
  int ndims_wgtz, dsizes_wgtz[NCL_MAX_DIMENSIONS], has_missing_wgtz;
