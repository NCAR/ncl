...
extern void nccf_make_gnomonic_cubic_hgrid(int nxbnds, int *nlon, 
					int *ndivx, int *ndivy,
					char *gridname, char *history);

NhlErrorTypes nccfmakegnomoniccubichgridW(void)
{
...
nccf_make_gnomonic_cubic_hgrid(*nxbnds, nlon, ndivx, ndivy, 
				gridname_charray, history);
