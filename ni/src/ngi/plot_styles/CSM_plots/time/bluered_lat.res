*ndvPlotStyleName : vs. latitude (blue/red)
...
*contour@ndvUpdateFunc2 : LabelLatY($contour$,30,15)
*contour@ndvUpdateFunc2%Profile : (/ Name : Latitude Tickmarks on Y Axis /)
*contour@ndvUpdateFunc3 : PlotTitles($contour$, \
                                      $left_title$,$cndata$@long_name, \
                                      $center_title$, "", \
                                      $right_title$, $cndata$@units, \
                                      0.024,1)
*contour@ndvUpdateFunc3%Profile : (/ Name : Plot Titles /)
