*ndvPlotStyleName : with color contours
*ndvPlotName      : vector
...
; map resources
;
*map@pmOverlays     : (/ $contour$, $vector$, $tickmark$ /)
...
*map@ndvUpdateFunc3%Profile : (/ Name : Adjust Contour Font Sizes /)
*map@ndvUpdateFunc4  : AdjustFontSizes($vector$,$tickmark$,1.0)
*map@ndvUpdateFunc4%Profile : (/ Name : Adjust Vector Font Sizes /)
...
*contour*pmLabelBarZone             : 2

;
; vector resources
;
*vector@vcVectorFieldData     : $vf$
*vector*vcRefAnnoZone         : 3
