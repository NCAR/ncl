...
*contour@ndvUpdateFunc3 : SetContourLevelThickness($contour$,0.,-1.)
*contour@ndvUpdateFunc3%Profile : (/ Name : Contour Level Thickness /)
*contour@ndvUpdateFunc4 : LtGtContourDashPattern($contour$,0.,-2,0.,-2)
*contour@ndvUpdateFunc4%Profile : (/ Name : Contour Dash Patterns /)
*contour@ndvUpdateFunc5 : LtGtContourFillPattern($contour$,0.,-2,1.0,\
                                                           0.,-2,1.0)
*contour@ndvUpdateFunc5%Profile : (/ Name : Contour Fill Patterns /)
*contour@ndvUpdateFunc6 : PlotTitles($contour$, \
                                      $left_title$, $cndata$@long_name, \
                                      $center_title$, "", \
                                      $right_title$, $cndata$@units, \
                                      0.024,1.2)
*contour@ndvUpdateFunc6%Profile : (/ Name : Plot Titles /)
*contour@ndvUpdateFunc7 : AdjustFontSizes($contour$,$contour$,1.0)
*contour@ndvUpdateFunc7%Profile : (/ Name : Adjust Contour Info Label Font Size /)
