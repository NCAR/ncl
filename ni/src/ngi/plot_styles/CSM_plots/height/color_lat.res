...
*sf@sfXArray%Profile    : (/ Name : Latitude /)
...
*contour@ndvUpdateFunc2: LabelLatX($contour$,30,15)
*contour@ndvUpdateFunc2%Profile : (/ Name : Latitude Tickmarks on X Axis /)
...
*contour@ndvUpdateFunc4 : SetContourLevels($contour$,0.,0.,0.)
*contour@ndvUpdateFunc4%Profile : (/ Name : Contour Level Control /)
*contour@ndvUpdateFunc5 : PlotTitles($contour$, \
                                      $left_title$, $cndata$@long_name, \
                                      $center_title$, "", \
                                      $right_title$, $cndata$@units, \
                                      0.024,1.2)
*contour@ndvUpdateFunc5%Profile : (/ Name : Plot Titles /)
*contour@ndvUpdateFunc6 : AdjustFontSizes($contour$,$contour$,1.0)
*contour@ndvUpdateFunc6%Profile : (/ Name : Adjust LabelBar Font Sizes /)
