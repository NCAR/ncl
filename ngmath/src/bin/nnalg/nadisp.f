...
C
  ...
  520   FORMAT(' Number of input data points = ',I8/' This exceeds the m
     +aximum allowed, which is ',I8)
        STOP
      ENDIF
C
...
C
  ...
  530   FORMAT(' Number of circumcircles = ',I8/' This exceeds the maxim
     +um allowed, which is ',I8)
        STOP
      ENDIF
      DO 60 I=1,NUMSIM
        CALL NASKLN(IUNIT,INLINE)
