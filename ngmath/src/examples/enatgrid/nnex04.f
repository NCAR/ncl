...
C  neighbor regridding package.  The only differecne between the
C  code used with extrapolation allowed and extrapolation not
C  allowed is the setting of the value of the parameter "ext".
C
...
C
      ...
      CALL NNSETR('NUL - function value when extrapolation not allowed',       
     +            -1.)
