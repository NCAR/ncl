.\"
.\"	$Id: c_cssgrid.m,v 1.1 1999-06-29 00:23:01 fred Exp $
.\"
.TH c_cssgrid 3NCARG "June 1999" UNIX "NCAR GRAPHICS"
.SH NAME
c_cssgrid - cubic spline interpolation on a sphere
...
.nf
.cs R 24
float *c_cssgrid (n, x, y, z, f, ni, nj, plat, plon, ier)
.fi
.cs R
.sp
.SH DESCRIPTION
...
value at (x[i],y[i],z[i]) for i = 0 to n-1. 
.IP ni 12
...
The values in plon should be in radians.
.IP ier 12
...
.SH USAGE
c_cssgrid is called to find an interpolating cubic spline for 
...
.nf
.cs R 24
  out = c_cssgrid(n, x, y, z, f, nlat, nlon, plat, plon, &ier);
.fi
.cs R
.sp
