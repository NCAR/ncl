...
C
C   $Id: cmfm1b.f,v 1.1 2006-10-27 16:34:08 haley Exp $
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
C
   ...
   65     CALL CMF5KB(LOT,IDO,L1,NA,CH,1,LOT,C,JUMP,INC,WA(IW))
          GO TO 120
   56     CALL CMFGKB(LOT,IDO,IP,L1,LID,NA,C,C,JUMP,INC,CH,CH,1,LOT,
     +                WA(IW))
          GO TO 120
   66     CALL CMFGKB(LOT,IDO,IP,L1,LID,NA,CH,CH,1,LOT,C,C,JUMP,INC,
     +                WA(IW))
  120     L1 = L2
          IW = IW + (IP-1)* (IDO+IDO)
          IF (IP.LE.5) NA = 1 - NA
