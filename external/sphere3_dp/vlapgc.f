...
c **********************************************************************
c
      SUBROUTINE DVLAPGC(NLAT,NLON,ITYP,NT,VLAP,WLAP,IDVW,JDVW,BR,BI,CR,
     +                  CI,MDBC,NDBC,WVHSGC,LVHSGC,WORK,LWORK,IERROR)
...
c
      ...
      CALL DVLAPGC1(NLAT,NLON,ITYP,NT,VLAP,WLAP,IDVW,JDVW,WORK(IBR),
     +             WORK(IBI),WORK(ICR),WORK(ICI),MMAX,WORK(IFN),MDBC,
     +             NDBC,BR,BI,CR,CI,WVHSGC,LVHSGC,WORK(IWK),LIWK,IERROR)
      RETURN
      END

      SUBROUTINE DVLAPGC1(NLAT,NLON,ITYP,NT,VLAP,WLAP,IDVW,JDVW,BRLAP,
...
c
      CALL DVHSGC(NLAT,NLON,ITYP,NT,VLAP,WLAP,IDVW,JDVW,BRLAP,BILAP,
