.TH Conrec_params 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
Conrec_params - This document briefly describes all Conrec
internal parameters.
.SH DESCRIPTION 
...
optional libraries one of which the ncargf77 command links in when the
-conrecquick, or -conrecsuper option is declared
on the command line.
.sp
