.TH VVGETR 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
VVGETR - 
...
code. For example, instead of just \'DMX\', use \'DMX - Device
Maximum Vector Size\'.
.IP RVL 12
...
ncarg_c, and ncarg_loc, preferably in that order.  To use c_vvgetr, load the 
