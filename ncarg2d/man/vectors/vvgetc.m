.TH VVGETC 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
VVGETC - 
Gets the current value of a
Vectors parameter of type CHARACTER.
.SH SYNOPSIS
CALL VVGETC (CNM,CVL) 
...
code. For example, instead of just \'MXT\', use \'MXT -
Maximum Vector Text String\'.
.IP CVL 12
(CHARACTER, output) is a variable in which the value of
...
.SH ACCESS
To use VVGETC, load the NCAR Graphics libraries ncarg, ncarg_gks,
ncarg_c, and ncarg_loc, preferably in that order.  To use c_vvgetc, load the 
