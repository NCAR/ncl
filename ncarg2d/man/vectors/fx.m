.TH FX 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
FX - 
...
the grid coordinate system.
.SH USAGE
The user does not invoke the function, FX, directly. In
...
coordinates are in the data coordinate system, FX takes
...
inclusion within the FX routine, supplies the information
necessary to perform the conversion into data coordinate
space, as well as for the mapping from data to user
coordinates. The default version of FX simply performs an
identity mapping from grid to user coordinate space.
.SH ACCESS
To use FX, load the NCAR Graphics libraries ncarg, ncarg_gks,
