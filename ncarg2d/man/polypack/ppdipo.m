.TH PPDIPO 3NCARG "March 1995" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
...
.SH ACCESS
To use PPDIPO, load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_c, preferably in that order.  To use c_ppdipo, load
