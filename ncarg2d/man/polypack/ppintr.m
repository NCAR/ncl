.TH PPINTR 3NCARG "March 1995" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
...
must appear in an EXTERNAL statement in the routine that calls PPINTR and
...
if no errors occurred in the execution of PPINTR or with a
...
.fi
.sp
causes the formation of an intersection polygon (of the subject and clip
clip polygons) and the delivery of trapezoids representing the interior of
...
.SH ACCESS
To use PPINTR, load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_c, preferably in that order.  To use c_ppintr, load
the NCAR Graphics libraries ncargC, ncarg_gksC, ncarg, ncarg_gks,
and ncarg_c, preferably in that order.
.SH SEE ALSO
Online:
polypack, ppdipo, ppditr, ppinpo, ppplcl, ppppap, ppunpo, ppuntr,
ncarg_cbind.
.sp
Hardcopy:
None.
