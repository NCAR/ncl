...
.SH ACCESS
To use TDINIT, load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_c, preferably in that order. To use c_tdinit,
load the NCAR Graphics libraries ncargC, ncarg_gksC, ncarg, 
ncarg_gks, and ncarg_c, preferably in that order.
.SH SEE ALSO
Online:
tdclrs, tddtri, tdgeti, tdgetr, tdgrds, tdgrid, tdgtrs, tditri, tdlbla,
