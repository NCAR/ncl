...
.SH ACCESS
To use TDGETI, load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_c, preferably in that order. To use c_tdgeti,
...
.SH SEE ALSO
Online:
tdclrs, tddtri, tdgetr, tdgrds, tdgrid, tdgtrs, tdinit, tditri, tdlbla,
