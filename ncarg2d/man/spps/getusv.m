.TH GETUSV 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.na
.nh
.SH NAME
...
.IP IV 12
(an output parameter value of type INTEGER) taken from the following
parameter table:
.nf
...
the routines GSCR, GSPLCI, GSFACI, GSPMCI, and GSTXCI.  See the document
"User's Guide for NCAR GKS-0A Graphics."  The corresponding GKS inquiry
routines to determine current color settings are GQCR, GQPLCI, GQFACI,
GQPMCI, and GQTXCI.
.sp
...
and ncarg_loc, preferably in that order.  To use c_getusv, load the 
