.\"
.\"	$Id: plchmq.m,v 1.1 1993-03-11 16:29:34 haley Exp $
.\"
.TH PLCHMQ 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.SH NAME
PLCHMQ - Plots characters of medium quality. It provides a
single font. The font contains uppercase and lowercase letters
of the Roman alphabet and some special characters.  All
characters are constant-spaced.
.SH SYNOPSIS
CALL PLCHMQ (XPOS, YPOS, CHRS, SIZE, ANGD, CNTR)
.SH C-BINDING SYNOPSIS
#include <ncarg/ncargC.h>
.sp
void c_plchmq (float xpos, float ypos, char *chrs, float size, float angd, float cntr)
.SH DESCRIPTION 
.IP "XPOS, YPOS" 12
...
= > ? @ ` [ \ ] ^ _ { | } tilde , .  blank
.sp
Function codes may not be used; they are available in
PLCHHQ only.
.sp
...
wide.
.IP 0.<SIZE<1. 12 
Specifies the desired width of a character
as a fraction of the distance across the
plotter frame.
.IP ">= 1." 12
...
.SH ACCESS
To use PLCHMQ, load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_loc, preferably in that order.  To use c_plchmq, load 
