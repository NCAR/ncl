.\"
.\"	$Id: conrec.m,v 1.1.1.1 1992-04-17 22:30:21 ncargd Exp $
.\"
.TH CONREC 3NCARG "MARCH 1988" NCAR "NCAR GRAPHICS"
.so MACRO_SOURCE
.dsNA " CONREC - Contours 2-d arrays, labeling contour lines
...
August 1987
.H 3 "Purpose"
CONREC draws a contour map from data stored
...
< 0 ABS(NDOT) pattern is used for negative-valued 
...
.H 3 "Common Blocks"
INTPR, RECINT, CONRE1, CONRE2, CONRE3,
CONRE4,CONRE5
.H 3 "Required Library Routines"
Standard version: DASHCHAR, which 
is loaded by default at NCAR.
...
FORTRAN 77
.H 3 "History"
Replaces old contouring package called
CALCNT at NCAR.
.H 3 "Algorithm"
...
.LI
IOFFP non-zero means special 
value feature in use.
(SPVAL is set to the special
value.) Contour lines will
then be omitted from any
cell with any corner equal
