.\"
.\"	$Id: pwrzt.m,v 1.1 1993-03-11 16:34:49 haley Exp $
.\"
...
.sp
void c_pwrzt (float x, float y, float z, char *id, int n, int isize, int line, int itop, int icnt)
.SH DESCRIPTION
.IP X,Y,Z 12
...
and ncarg_loc, preferably in that order.  To use c_pwrzt load 
