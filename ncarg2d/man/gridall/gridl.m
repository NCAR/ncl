.\"
.\"	$Id: gridl.m,v 1.1 1993-03-11 16:26:45 haley Exp $
.\"
.TH GRIDL 3NCARG "March 1993" UNIX "NCAR GRAPHICS"
.SH NAME
GRIDL - Draws a labeled grid with each major division labeled
with it's numeric value.
.SH SYNOPSIS
...
.SH ACCESS
To use GRIDL load the NCAR Graphics libraries ncarg, ncarg_gks,
and ncarg_loc, preferably in that order.  To use c_gridl load 
