.\"
.\"	$Id: ginq_norm_tran.m,v 1.1 1993-03-21 01:30:30 haley Exp $
.\"
...
.IP norm_tran->win 12
(Output) - The world coordinate window limits.
.IP norm _tran->vp 12
(Output) - The normalized device coordinate viewport limits.
.SH ACCESS
