C
C	$Id: gksbd.f,v 1.1.1.1 1992-04-17 22:33:40 ncargd Exp $
C
      BLOCKDATA GKSBD
C
...
C       WCONID  -- CONECTION IDENTIFIER FOR WISS
...
C       SWKTP  -- SET OF WORKSTATION TYPES
C       NOPICT -- FLAG TO INDICATE NO PICTURE ELEMENTS HAVE BEEN
C                 ISSUED FOR THE CURRENT PICTURE
C       NWKTP  -- WORKSTATION TYPE
C       MODEF  -- LEVEL OF THE STATE OF THE GFLASH PACKAGE USED
C                 TO CONTROL WHEN TO ISSUE PICTURE INITIALIZATION
C-----------------------------------------------------------------------
C
...
C-----------------------------------------------------------------------
C
C     GKSNAM: GKS SUBROUTINE NAMES AS PER THE GKS FORTRAN BINDING
C
...
C
C-----------------------------------------------------------------------
      DATA KSLEV,WK,LSWK(1),LSWK(2),MOPWK,MACWK,MNT
     +    /    0, 2,      1,      3,    2,    1,  1/
      DATA OPS/0/
      DATA ERS,ERF/0,6/
      ...
      DATA NOPWK ,NACWK,WCONID,NUMSEG,CURSEG /0,0,3,0,-1/
      DATA NOPICT,MODEF/-1,0/
