C
C	$Id: gstxal.f,v 1.1.1.1 1992-04-17 22:33:51 ncargd Exp $
C
...
C
      IF (TXALH.LT.0.OR.TXALH.GT.3.OR.TXALV.LT.0.OR.TXALV.GT.5) THEN
      ERS = 1
      ...
      ENDIF
C
C     SET THE CURRENT TEXT ALIGNMENT VARIABLES
