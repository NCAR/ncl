C
C	$Id: gqpa.f,v 1.1.1.1 1992-04-17 22:33:44 ncargd Exp $
C
...
C     CHECK IF GKS IS IN PROPER STATE
      ...
      IF (ERRIND.EQ.0) THEN
C
C     Pattern width and height vectors will always be
C     along the coordinate axes since no metafile interpretation
C     functions are in the package.
C
      PWX = CPA(1)
      PWY = 0.
      PHX = 0.
