/*
 *	$Id: c_cezmap3.c,v 1.1 1994-07-20 17:05:47 haley Exp $
 */
#include <stdio.h>
#include <math.h>
 ...
 * Invoke demo driver
 */
	cezmap("SV",40.,-50.,0.,"PO","MA",plim1,plim2,plim3,plim4);
/*
...
void cezmap(proj, plat, plon, rota, outln, jlim, plim1, plim2, plim3, plim4)
