/*
 *	$Id: c_arex01.c,v 1.1 1994-10-31 04:21:08 haley Exp $
 */
#include <stdio.h>
#include <math.h>
...
NGCALLF(ardbpa,ARDBPA)(iama,igip,labl)
int *iama, *igip;
char *labl;
{
/*
...
one:
    rxco=rxcn;
    ryco=rycn;
    rxcn=(float)(iama[indx])/NGCALLF(arcomn,ARCOMN).rlc;
    rycn=(float)(iama[indx+1])/NGCALLF(arcomn,ARCOMN).rlc;
 ...
 * quit ...
 */
    NGCALLF(arcom1,ARCOM1).dt=arcom1_.dt+dp;
    if(NGCALLF(arcom1,ARCOM1).dt <= .008) return(1);
/*
