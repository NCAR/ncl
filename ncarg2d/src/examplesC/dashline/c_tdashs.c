/*
 *	$Id: c_tdashs.c,v 1.1 1994-05-13 14:26:16 haley Exp $
 */
#include <stdio.h>
#include <math.h>
...
{
/*
 * PURPOSE                To provide a simple demonstration of DASHSMTH
 *
 * USAGE                  CALL TDASHS (IERROR)
 *
 * ARGUMENTS
 *
 * ON OUTPUT              IERROR
 ...
 *
 *               DASHSMTH TEST EXECUTED--SEE PLOT TO CERTIFY
 *
 ...
 */
    ...
    text_pos.x = .5;
    text_pos.y = .985;
    gtext (&text_pos,"DEMONSTRATION PLOT FOR DASHSMTH");
    text_pos.y = .013;
    gtext (&text_pos,"IN IPAT STRINGS, A AND D SHOULD BE INTERPRETED AS APOSTROPHE AND DOLLAR SIGN");
    c_frame();
    *ierror = 0;
    printf(" DASHSMTH TEST EXECUTED--SEE PLOT TO CERTIFY\n");
    return(1);
}
