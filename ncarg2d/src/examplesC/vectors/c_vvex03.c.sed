...
int vvumxy_(x,y,u,v,uvm,xb,yb,xe,ye,ist)
 ...
 */
        if (i < 1 || i > vvmap_.nxct || j < 1 || j > vvmap_.nyct) {
            *ist = -1;
            return(0);
        }
        xt = xcoord[i-1];
 ...
 * of the user space.
 */
        if (xt < vvmap_.wxmn || xt > vvmap_.wxmx || yt < vvmap_.wymn || yt > vvmap_.wymx) {
            *ist = -1;
            return(0);
        }
        *xb = c_cufx(xt);
 ...
 */
        xt = xcoord[vvmap_.nxct*(j-1)+i-1];
        yt = ycoord[vvmap_.nxct*(j-1)+i-1];
 ...
 */
        ...
        if (*xb < vvmap_.wxmn || *xb > vvmap_.wxmx || *yb < vvmap_.wymn || *yb > vvmap_.wymx) {
            *ist=-5;
            return(0);
        }
/*
 ...
 */
        if (*x < vvmap_.wxmn || *x > vvmap_.wxmx || *y < vvmap_.wymn || *y > vvmap_.wymx) {
            *ist = -1;
            return(0);
        }
        *xb = c_cufx(*x);
