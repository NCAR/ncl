 ...
 */
    ...
    rgbs[5].rgb.red = .4;    rgbs[5].rgb.green = 0.;    rgbs[5].rgb.blue = .4;
 ...
 */
    ...
    c_pcseti("FN",25);
    c_pcseti("CC",5);
    c_plchhq(.5,.93,"Text Colors and Paths",.028,0.,0.);
    c_plchhq(.5,.88,"Font = triplex Roman",.028,0.,0.);
    x = .193; y = .826;
    cross(x,y);
 ...
 */
    gset_text_path(GPATH_DOWN);
    ginq_text_path(&err_ind,&itp);
    if( itp != 3 ) {
        printf( "c_pgkex10:  GINQ_TEXT_PATH UNSUCCESSFUL\n" );
	}
/*
