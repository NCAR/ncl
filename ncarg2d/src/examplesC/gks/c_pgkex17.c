/*
 *	$Id: c_pgkex17.c,v 1.1 1994-06-29 19:49:20 haley Exp $
 */
#include <stdio.h>
 ...
 */
    ...
    rgb[1].rgb.red = 0.; rgb[1].rgb.green = 0.; rgb[1].rgb.blue = 0.;
    rgb[2].rgb.red = 0.; rgb[2].rgb.green = 0.; rgb[2].rgb.blue = 1.;
    rgb[3].rgb.red = .4; rgb[3].rgb.green = 0.; rgb[3].rgb.blue = .4;
    rgb[4].rgb.red = 1.; rgb[4].rgb.green = 0.; rgb[4].rgb.blue = 0.;
    for( i = 0; i <= 4; i++ ) {
 ...
 */
        gset_fill_int_style(GSTYLE_SOLID);
        c_plchhq(x-.17,y-.004,"Hatch,",.018,0.,-1.);
        sprintf(label,"index %1d",i);
        gset_fill_int_style(GSTYLE_SOLID);
        c_plchhq(x-.17,y-.034,label,.018,0.,-1.);
    }
/*
 *  Main plot label.
 */
    c_pcseti("FN",25);
    c_pcseti("CC",3);
    c_plchhq(.5,.95,"Fill area interior styles",.035,0.,0.);
    c_frame();
/*
