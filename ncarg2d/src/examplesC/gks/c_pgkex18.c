/*
 *	$Id: c_pgkex18.c,v 1.1 1994-06-29 19:49:20 haley Exp $
 */
#include <stdio.h>
#include <math.h>
 ...
 */
    ...
    c_plchhq(xl+.5*(xr-xl),yb+(yt-yb)*1.07,"Cell Array",.033,0.,0.);
    c_frame();
/*
 ...
 */
    ...
    if( colr_ind != NITER+1 ) {
        printf( "c_pgkex18:  GINQ_LINE_COLR_IND UNSUCCESSFUL\n" );
    }
/*
 * Test ginq_clip
 */
    ginq_clip(&err_ind,&clip_ind);
    if( clip_ind.clip_ind != GIND_NO_CLIP ) {
        printf( "c_pgkex18:  GINQ_CLIP_IND UNSUCCESSFUL\n" );
    }
/*
