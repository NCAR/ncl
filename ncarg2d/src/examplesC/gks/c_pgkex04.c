 ...
 */
	...
	rgb[1].rgb.red = 0.; rgb[1].rgb.green = 0.; rgb[1].rgb.blue = 1.;
	rgb[2].rgb.red = 1.; rgb[2].rgb.green = 0.; rgb[2].rgb.blue = .2;
 ...
 */
	c_pcseti("FN",25);
	c_pcseti("CC",3);
	c_plchhq(.5,.83,"Normalization transformation",.035,0.,0.);
	c_pcseti("FN",21);
	c_pcseti("CC",3);
	...
	c_pcseti("FN",9);
	c_pcseti("CC",2);
	c_plchhq(.5,.22,"Normalization transformation defined by",.0275,0.,0.);
	c_pcseti("FN",29);
	c_pcseti("CC",3);
