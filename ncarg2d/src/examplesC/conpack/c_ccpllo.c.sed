...
{
	int i;			/* counter */
        int iwrk[LRWK];         /* real work array */
        int map[LMAP];          /* map data array */
	int ncons;		/* number of contour levels */

        float rwrk[LRWK];       /* real work array */
        float x[MREG];       	/* x coord. of output grid points */
        float y[NREG];       	/* y coord. of output grid points */
...
/* Set labels so that they are drawn parallel to the contour line */
