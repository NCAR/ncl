C
C	$Id: fdvdld.f,v 1.1.1.1 1992-04-17 22:34:57 ncargd Exp $
C
...
C
C   2.) SET THE CONSTANT ISKIP IN BLOCK DATA DASHBD.
C       SEE COMMENTS IN DASHBD FOR DETAILS.
C
