C
C $Id: mapbla.f,v 1.9 1996-05-07 21:38:21 kennison Exp $
C
...
C
      IF (.NOT.(ICFELL('MAPBLA - UNCLEARED PRIOR ERROR',1).NE.0))
     +GO TO 10000
      IIER=-1
      RETURN
10000 CONTINUE
...
C
      ...
      IF (.NOT.(ICFELL('MAPBLA',7).NE.0)) GO TO 10066
      IIER=-1
      RETURN
10066 CONTINUE
10065 CONTINUE
