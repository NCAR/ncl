C
C $Id: mapbla.f,v 1.3 1994-03-17 00:04:25 kennison Exp $
C
...
C
      ...
      IF (.NOT.(ICFELL('MAPBLA',7).NE.0)) GO TO 10065
      IIER=-1
      RETURN
10065 CONTINUE
10064 CONTINUE
...
C
      ...
      IF (.NOT.(ICFELL('MAPBLA',10).NE.0)) GO TO 10067
      IIER=-1
      RETURN
10067 CONTINUE
...
10004 CONTINUE
      ...
      IF (.NOT.(ICFELL('MAPBLA',14).NE.0)) GO TO 10071
      IIER=-1
      RETURN
10071 CONTINUE
10070 CONTINUE
...
10009 CONTINUE
      ...
      CALL AREDAM (IAMP,XCRA,YCRA,NCRA,IGRP,IDLT,IDRT)
      IF (.NOT.(ICFELL('MAPBLA',15).NE.0)) GO TO 10073
      IIER=-1
      RETURN
10073 CONTINUE
      XCRA(1)=XCRA(100)
...
10018 CONTINUE
      ...
      CALL AREDAM (IAMP,XCRA,YCRA,NCRA,IGRP,IDLT,IDRT)
      IF (.NOT.(ICFELL('MAPBLA',16).NE.0)) GO TO 10075
      IIER=-1
      RETURN
10075 CONTINUE
      NCRA=0
