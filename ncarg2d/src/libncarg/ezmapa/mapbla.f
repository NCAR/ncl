C
C $Id: mapbla.f,v 1.2 1993-12-21 00:44:44 kennison Exp $
C
...
C
  101 DLAT=GRDR
      ...
      IF (ICFELL('MAPBLA',1).NE.0) RETURN
      DO 10020 J=1,K-1
      RLAT=RLAT+DLAT
...
C
      ...
      IF (.NOT.(ICFELL('MAPBLA',6).NE.0)) GO TO 10065
      IIER=-1
      RETURN
10065 CONTINUE
10064 CONTINUE
...
C
      ...
      IF (.NOT.(ICFELL('MAPBLA',9).NE.0)) GO TO 10067
      IIER=-1
      RETURN
10067 CONTINUE
...
10004 CONTINUE
      ...
      IF (.NOT.(ICFELL('MAPBLA',13).NE.0)) GO TO 10071
      IIER=-1
      RETURN
10071 CONTINUE
10070 CONTINUE
...
10009 CONTINUE
      ...
      CALL AREDAM (IAMP,XCRA,YCRA,NCRA,IGRP,IDLT,IDRT)
      IF (.NOT.(ICFELL('MAPBLA',14).NE.0)) GO TO 10073
      IIER=-1
      RETURN
10073 CONTINUE
      XCRA(1)=XCRA(100)
...
10018 CONTINUE
      ...
      CALL AREDAM (IAMP,XCRA,YCRA,NCRA,IGRP,IDLT,IDRT)
      IF (.NOT.(ICFELL('MAPBLA',15).NE.0)) GO TO 10075
      IIER=-1
      RETURN
10075 CONTINUE
      NCRA=0
10074 CONTINUE
      GO TO (10017,10021,10031,10041,10060,10069) , L10018
C
      END
