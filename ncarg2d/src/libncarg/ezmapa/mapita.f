C
C $Id: mapita.f,v 1.6 1994-05-03 21:24:38 kennison Exp $
C
...
C
      IF (.NOT.(ICFELL('MAPITA - UNCLEARED PRIOR ERROR',1).NE.0))
     +GO TO 10000
      IIER=-1
      RETURN
10000 CONTINUE
...
10034 CONTINUE
      ...
      IF (.NOT.(ICFELL('MAPITA',4).NE.0)) GO TO 10070
      IIER=-1
      RETURN
10070 CONTINUE
10069 CONTINUE
...
10025 CONTINUE
      ...
      CALL AREDAM (IAMP,XCRA,YCRA,NCRA,IGRP,IDLT,IDRT)
      IF (.NOT.(ICFELL('MAPITA',5).NE.0)) GO TO 10072
      IIER=-1
      RETURN
10072 CONTINUE
      XCRA(1)=XCRA(100)
