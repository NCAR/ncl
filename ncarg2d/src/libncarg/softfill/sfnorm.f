C
C $Id: sfnorm.f,v 1.3 1994-03-17 20:58:42 kennison Exp $
C
...
C
10020 CONTINUE
      IF (.NOT.(KND.LE.NND)) GO TO 10084
      DO 10085 I=KND,NND
      IF (.NOT.(IND(I).EQ.IPX)) GO TO 10086
      IND(I)=IND(KND)
      KND=KND+1
      GO TO 101
10086 CONTINUE
