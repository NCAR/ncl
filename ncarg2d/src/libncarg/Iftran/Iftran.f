      PROGRAM IFTRAN
C
C $Id: Iftran.f,v 1.4 2005-04-07 21:21:38 kennison Exp $
C
...
10010 CONTINUE
  ...
  107 CALL CCSET(ISTA(ISTC),ICHS( 6))
      GO TO 199
  115 CONTINUE
      IF (.NOT.(IABS(IFVA(IFVI)).EQ.1)) GO TO 10011
      IFVA(IFVI)=-2*IFVA(IFVI)
      GO TO 10012
10011 CONTINUE
      IF (.NOT.(IABS(IFVA(IFVI)).EQ.2)) GO TO 10013
      CALL ERRM(8)
      GO TO 10012
10013 CONTINUE
...
10032 CONTINUE
      ...
      GO TO 10030
10031 CONTINUE
      IF (.NOT.(IABS(IFVA(IFVI)).EQ.2)) GO TO 10033
      CALL ERRM(8)
10030 CONTINUE
10033 CONTINUE
      GO TO 199
...
10007 CONTINUE
     ...
     +).AND.IPOS.NE.0))) GO TO 10002
      NIST=MAX0(NEST,0)
      JDNT=IABS(NDNT)
      NIND=MIN0(NIST*JDNT,116-LNCD)
      KSEQ=201-LNCD
      LSEQ=LNCD-72
      IF (.NOT.(ITYP.EQ.ICHS(4).AND.NIST.NE.0)) GO TO 10003
      NIND=MIN0(NIND,112-LNCD)
      ISPL=1
      KSPL=18+NIND
      IDOT=ICHS(42)
      GO TO 10004
...
10001 CONTINUE
  ...
  101 NOTEQ=I
     ...
     +                ISRC,ISTA,ITBC,ITYP,IUSB,IXCC,NAMC,PTYP
      ...
      CALL CVD(MAX0(NEST,0),IBUF(73),3)
...
10045 CONTINUE
  ...
  106 CALL ERRM(32)
     ...
     +                ISRC,ISTA,ITBC,ITYP,IUSB,IXCC,NAMC,PTYP
      ...
      CHARACTER*1 ITCH
  101 IEOF=0
      IF (.NOT.(IABS(IUAF).EQ.1)) GO TO 10001
...
10001 CONTINUE
      ...
      GO TO 10003
10004 CONTINUE
      IF (.NOT.(IABS(INCP).EQ.1)) GO TO 10005
      LNRD=MIN0(LNCD,INCL)
...
10103 CONTINUE
  ...
  204 CONTINUE
      ...
      IOPS(NOPS-1)=MAX0(IOPS(NOPS-1),IOPS(NOPS))
      NOPS=NOPS-1
10107 CONTINUE
10106 CONTINUE
      GO TO 299
  205 CONTINUE
      ...
      IOPS(NOPS-1)=MIN0(IOPS(NOPS-1),IOPS(NOPS))
      NOPS=NOPS-1
10109 CONTINUE
10108 CONTINUE
      GO TO 299
...
10116 CONTINUE
  ...
  210 CONTINUE
      ...
      GO TO 10021
10119 CONTINUE
      IOPS(NOPS-1)=ISIGN(IOPS(NOPS-1),IOPS(NOPS))
      GO TO 298
  211 CONTINUE
      GO TO 10021
  298 NOPS=NOPS-NAM1
