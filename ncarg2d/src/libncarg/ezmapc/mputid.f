C
C $Id: mputid.f,v 1.1 1999-04-19 22:09:56 kennison Exp $
C
...
C
     ...
     +         121,122,123                             ) , IPRO
C
  101   CALL PJ01DP (CRDI,CRDO,1)
        IF (IERR.EQ.0) CALL PJ01DP (CRDO,CRDT,0)
        GO TO 201
C
  102   CALL PJ02DP (CRDI,CRDO,1)
        IF (IERR.EQ.0) CALL PJ02DP (CRDO,CRDT,0)
        GO TO 201
C
