C
C $Id: pj23z0.f,v 1.1 1999-04-02 23:06:04 kennison Exp $
C
...
C
         ...
         GEOG(2) = COORD(2)
         IERROR = 0
         IF (MPDFAL(GEOG).GT.30.D0) THEN
           IF (IPEMSG.EQ.0) WRITE (IPELUN,2020)
 2020      FORMAT (/' ERROR PJ23Z0'/
