C
C	$Id: cpback.f,v 1.1.1.1 1992-04-17 22:32:42 ncargd Exp $
C
C
C***********************************************************************
C C O N P A C K   -   U S E R - L E V E L   S U B R O U T I N E S
C***********************************************************************
C
...
C
      IF (INIT.EQ.0) THEN
        CALL SETER ('CPBACK - INITIALIZATION CALL NOT DONE',1,2)
        STOP
      END IF
C
...
C
      IF (IMPF.EQ.0) CALL PERIM (IZDM-1,0,IZDN-1,0)
C
C Done.
C
      RETURN
