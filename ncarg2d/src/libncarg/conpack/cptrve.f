C
C $Id: cptrve.f,v 1.11 2002-01-29 22:48:45 kennison Exp $
C
C                Copyright (C)  2000
...
10043   CONTINUE
C
        IF (.NOT.(IAID.NE.IAIC)) GO TO 10050
          IF (.NOT.(NPLS.GT.1)) GO TO 10051
            XSAV=RWRK(IR01     +NPLS)
...
C
     ...
     +YDUM).LE..0001*ABS(YVPT-YVPB))) GO TO 10053
