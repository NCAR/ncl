C
C	$Id: cphllb.f,v 1.1.1.1 1992-04-17 22:32:48 ncargd Exp $
C
C
C-----------------------------------------------------------------------
C
...
C
        ...
        IF (IGER.NE.0) THEN
          CALL SETER ('CPHLLB - ERROR EXIT FROM GQPLCI',1,2)
          STOP
        END IF
        CALL GQTXCI (IGER,ISTC)
        IF (IGER.NE.0) THEN
          CALL SETER ('CPHLLB - ERROR EXIT FROM GQTXCI',2,2)
          STOP
        END IF
        CALL GQFACI (IGER,ISFC)
        IF (IGER.NE.0) THEN
          CALL SETER ('CPHLLB - ERROR EXIT FROM GQFACI',3,2)
          STOP
        END IF
C
        IF (ICHI.GE.0) THEN
          ...
          ELSE IF (IACT.EQ.2) THEN
            ...
            IF (MOD(IBHL,2).NE.0) THEN
              ...
              IF (WDTH.GT.0.) THEN
                ...
                IF (IGER.NE.0) THEN
                  CALL SETER ('CPHLLB - ERROR EXIT FROM GQLWSC',4,2)
                  STOP
                END IF
                CALL PLOTIF (0.,0.,2)
                CALL GSLWSC (WDTH)
