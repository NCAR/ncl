C
C $Id: cthlso.f,v 1.2 2004-03-19 22:51:55 kennison Exp $
C
C                Copyright (C)  2000
...
C USA.
C
      SUBROUTINE CTHLSO (RWRK,IDRW,MRWK,NRWK,IWRK)
C
...
C and an integer array IWRK of length MRWK*NRWK, CTHLSO returns in IWRK
...
C
      IF (IDRW.EQ.MRWK) THEN
        CALL CTHLS2 (RWRK,MRWK*NRWK,IWRK)
C
C Otherwise ...
C
      ELSE
