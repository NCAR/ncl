...
C
      CALL PCSETI('CD',1)
      CALL GSPLCI(1)
      CALL PLCHHQ(X0,Y0+R+.05,'Marker 1 (dot)',.018,0.,0.)
C
...
C
      CALL PCSETI('CD',1)
      CALL GSPLCI(1)
      CALL PLCHHQ(X0,Y0+R+.05,'Marker 2 (plus)',.018,0.,0.)
C
...
C
      CALL PCSETI('CD',1)
      CALL GSPLCI(1)
      CALL PLCHHQ(X0,Y0+R+.05,'Marker 3 (asterisk)',.018,0.,0.)
C
...
C
      CALL PCSETI('CD',1)
      CALL GSPLCI(1)
      CALL PLCHHQ(X0,Y0+R+.05,'Marker 4 (circle)',.018,0.,0.)
C
...
C
      CALL PCSETI('CD',1)
      CALL GSPLCI(1)
      CALL PLCHHQ(X0,Y0+R+.05,'Marker 5 (cross)',.018,0.,0.)
C
