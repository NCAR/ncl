...
C
        CALL GTWNG2 (RPNT,MPNT,NPNT,LOPN,  !  point list
...
C
            ...
            R1=REAL(NOPX-INDX+1)/REAL(NOPX)    !  1-P1
            P2=REAL(INDX)/REAL(NOPX)
            R2=REAL(NOPX-INDX)/REAL(NOPX)      !  1-P2
C
            DO 104 INDY=1,NOPY
C
              Q1=REAL(INDY-1)/REAL(NOPY)
              S1=REAL(NOPY-INDY+1)/REAL(NOPY)  !  1-Q1
              Q2=REAL(INDY)/REAL(NOPY)
              S2=REAL(NOPY-INDY)/REAL(NOPY)    !  1-Q2
C
