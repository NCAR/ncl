C
C	$Id: elblba.f,v 1.1.1.1 1992-04-17 22:33:17 ncargd Exp $
C
      PROGRAM XAMPLE
C
...
C
        ...
        CALL PCSETR ('CS - CONSTANT SPACING',0.)
        CALL PLCHHQ (.5,.90,'THREE',.025,0.,0.)
        CALL PLCHHQ (.5,.85,'LABELBAR',.025,0.,0.)
        CALL PLCHHQ (.5,.80,'EXAMPLES',.025,0.,0.)
C
C Advance the frame.
C
        CALL FRAME
