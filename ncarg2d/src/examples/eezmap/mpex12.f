...
C
        WRITE (*,'('' '')')
        WRITE (*,'(''  Short name at various display levels:'')')
        WRITE (*,'('' '')')
C
        CTMP=MPNAME(MPIOAR(IAID,5))
        WRITE (*,'(''    MPNAME(MPIOAR(IAID,5)) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPNAME(MPIOAR(IAID,4))
        WRITE (*,'(''    MPNAME(MPIOAR(IAID,4)) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPNAME(MPIOAR(IAID,3))
        WRITE (*,'(''    MPNAME(MPIOAR(IAID,3)) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPNAME(MPIOAR(IAID,2))
        WRITE (*,'(''    MPNAME(MPIOAR(IAID,2)) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPNAME(MPIOAR(IAID,1))
        WRITE (*,'(''    MPNAME(MPIOAR(IAID,1)) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
C
        WRITE (*,'('' '')')
        ...
        WRITE (*,'('' '')')
C
        WRITE (*,'(''    MPISCI(MPIOAR(IAID,5)) = '',I1)')
     +                                            MPISCI(MPIOAR(IAID,5))
        WRITE (*,'(''    MPISCI(MPIOAR(IAID,4)) = '',I1)')
     +                                            MPISCI(MPIOAR(IAID,4))
        WRITE (*,'(''    MPISCI(MPIOAR(IAID,3)) = '',I1)')
     +                                            MPISCI(MPIOAR(IAID,3))
        WRITE (*,'(''    MPISCI(MPIOAR(IAID,2)) = '',I1)')
     +                                            MPISCI(MPIOAR(IAID,2))
        WRITE (*,'(''    MPISCI(MPIOAR(IAID,1)) = '',I1)')
     +                                            MPISCI(MPIOAR(IAID,1))
C
        WRITE (*,'('' '')')
        WRITE (*,'(''  Full name at various display levels:'')')
        WRITE (*,'('' '')')
C
        CTMP=MPFNME(MPIOAR(IAID,5),5)
        WRITE (*,'(''    MPFNME(MPIOAR(IAID,5),5) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPFNME(MPIOAR(IAID,4),4)
        WRITE (*,'(''    MPFNME(MPIOAR(IAID,4),4) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPFNME(MPIOAR(IAID,3),3)
        WRITE (*,'(''    MPFNME(MPIOAR(IAID,3),3) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPFNME(MPIOAR(IAID,2),2)
        WRITE (*,'(''    MPFNME(MPIOAR(IAID,2),2) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
        CTMP=MPFNME(MPIOAR(IAID,1),1)
        WRITE (*,'(''    MPFNME(MPIOAR(IAID,1),1) = '',A)')
     +                                              CTMP(1:MPILNB(CTMP))
C
        WRITE (*,'('' '')')
