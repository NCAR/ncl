C
C	$Id: agex09.f,v 1.1.1.1 1992-04-17 22:33:09 ncargd Exp $
C
      PROGRAM EXMPL9
C
...
C
      DO 102 I=1,400
        YDAT(I)=SIGN(ALOG10(AMAX1(ABS(YDAT(I)),.01))+2.0001,
     +               YDAT(I))
  102 CONTINUE
C
...
C
      IF (FUNS.EQ.1.) THEN
        IF (IDMA.LT.0) THEN
          VOTP=SIGN(ALOG10(AMAX1(ABS(VINP),.01))+2.0001,VINP)
        ELSE
