...
C Make room at the bottom for the information label
	CALL CPSETR('VPB - VIEWPORT BOTTOM',0.1)
C Set up label box options
	...
	CALL CPSETR('LLW - LINE LABEL WHITE SPACE WIDTH',.02)
	CALL CPSETR('HLW - HIGH/LOW LABEL WHITE SPACE WIDTH',0.)
	CALL CPSETR('ILW - INFORMATIONAL LABEL WHITESPACE WIDTH',.03)
