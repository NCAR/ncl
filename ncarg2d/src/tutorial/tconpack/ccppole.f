...
C
        ...
        CALL GSCR (1, 2,0.000,1.000,1.000)
        CALL GSCR (1, 3,0.000,0.850,0.850)
        CALL GSCR (1, 4,0.700,0.700,0.700)
        CALL GSCR (1, 5,0.750,0.500,1.000)
        CALL GSCR (1, 6,0.500,0.000,1.000)
        CALL GSCR (1, 7,0.000,0.000,1.000)
        CALL GSCR (1, 8,0.000,0.500,1.000)
        CALL GSCR (1, 9,0.000,1.000,0.600)
        CALL GSCR (1,10,0.000,1.000,0.000)
        CALL GSCR (1,11,0.700,1.000,0.000)
        CALL GSCR (1,12,1.000,1.000,0.000)
        CALL GSCR (1,13,1.000,0.750,0.000)
        CALL GSCR (1,14,1.000,0.380,0.380)
        CALL GSCR (1,15,1.000,0.000,0.380)
        CALL GSCR (1,16,1.000,0.000,0.000)
C
