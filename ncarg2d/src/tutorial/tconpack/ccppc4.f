...
C 
C Set the optimum distance term so that labels are far appart
C 
      CALL CPSETR('PC4 - PENALTY SCHEME CONSTANT 4',0.1)
      CALL CPSETR('PC5 - PENALTY SCHEME CONSTANT 5',0.2)
      CALL CPSETR('PC6 - PENALTY SCHEME CONSTANT 6',0.05)
      CALL CPSETR('PW4 - PENALTY SCHEME WEIGHT 4',5.0)
C 
